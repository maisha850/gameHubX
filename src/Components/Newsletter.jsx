...
const Newsletter = () => {
    return (
        <div className='rounded-xl shadow-sm my-10 h-100 bg-cover bg-no-repeat bg-center ' style={{backgroundImage:`url(${bg})`}}>
            ...
            <p className='font-bold text-4xl text-white'>To Get Exclusive Benefits</p>
           <div className='flex gap-2'>
          
             <input type="email" className='input text-slate-500 h-13 rounded-xl text-lg w-150 bg-none' placeholder='Email Address' />
            <input className='btn w-30 h-13 rounded-xl  bg-linear-to-r from-[#632EE3] to-pink-500 text-white' type="submit" value="Subscribe" />
           </div>
            </div>
